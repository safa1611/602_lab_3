node('linux') {
        ...
        stage('Create Test Stack') {
             ...
             withCredentials([[$class: 'AmazonWebServicesCredentialsBinding', accessKeyVariable: 'AKIA5UKGQWGSJI5BW6RC', credentialsId: '', secretKeyVariable: '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 Hide']]) {
